    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7 mb-5">
                <form action="{{ route('website.contact') }}" class="p-5 bg-white" method="POST">
                    @csrf
                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            ...
                            <input type="subject" id="subject" name="subject" placeholder="Enter Topic Subject" class="form-control">
                        </div>
                    </div>
                    <div class="row form-group">
                        <div class="col-md-12">
            ...
            <div class="col-md-5">
                <div class="p-4 mb-3 bg-white">
                    ...
                    <p class="mb-0">
                        ...
                        data-cfemail="9ae3f5efe8fff7fbf3f6dafef5f7fbf3f4b4f9f5f7">[email&#160;protected]</span> --}}
                            {{ $setting->email }}
                        </a>
                    </p>
                </div>
